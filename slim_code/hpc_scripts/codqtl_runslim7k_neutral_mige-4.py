...
output_dir= dir + "K7000_m1e-4_neutral/"
...
def run_sim(i):
	...
	try:
		subprocess.check_output(["/home/br450/build_082622/slim","-m","-d","K=7000","-d","m=0.0001","-d","simLof07file='"+Lof07out+"'","-d","simCan40file='"+Can40out+"'","-d","simLof11file='"+Lof11out+"'","-d","simLof14file='"+Lof14out+"'","-d","simCan13file='"+Can13out+"'","-d","simoutfile='"+simout+"'","-d","migoutfile='"+migout+"'",slim_template])
